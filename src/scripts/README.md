...
##### `entries`
Discrete js bundle entry points. A js file will be bundled for each item. Paths are relative to the `scripts` folder. This maps directly to `webpackConfig.entry`.
